...
class ComponentAccessToken implements RefreshableAccessTokenInterface
{
    ...
    public function __construct(
        ...
        $this->httpClient = $httpClient ?? HttpClient::create(['base_uri' => 'https://developer.toutiao.com/']);
        $this->cache = $cache ?? new Psr16Cache(new FilesystemAdapter(namespace: 'HelloDouYin', defaultLifetime: 1500));
    }
