...
use HelloDouYin\Kernel\Support\AesEcb;
use HelloDouYin\Kernel\Support\AesGcm;
...
class Server implements ServerInterface
{
     ...
     * @throws RuntimeException
     */
    public function getRequestMessage(?ServerRequestInterface $request = null): \HelloDouYin\Kernel\Message|Message
    {
        $originContent = (string) ($request ?? $this->request)->getBody();

        // 微信支付的回调数据回调，偶尔是 XML https://github.com/w7corp/HelloDouYin/issues/2737
        // PS: 这帮傻逼，真的是该死啊
     ...
     * @throws RuntimeException
     */
    public function getDecryptedMessage(?ServerRequestInterface $request = null): \HelloDouYin\Kernel\Message|Message
    {
